	...
	<div id="_movies_only_<?php echo $this->get_field_id( 'media_only' ); ?>" style="<?php if ( 0 !== $media_only ) echo 'display:none'; ?>">
		<p>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id( 'css' ); ?>"><?php _e( 'Custom Style (only for dropdown)', 'wpml' ); ?></label><br />
		</p>
	</div>