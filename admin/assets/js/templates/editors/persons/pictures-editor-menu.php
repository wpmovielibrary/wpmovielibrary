					  ...
					  <div class="panel-title"><?php esc_html_e( 'Posters', 'wpmovielibrary' ); ?></div>
            <div class="field filter-field">
              <div class="field-label"><?php esc_html_e( 'Language', 'wpmovielibrary' ); ?></div>
              <div class="field-value">
                <div class="field-control">
                  <select id="pictures-language-filter" data-filter="language" data-selectize="1">
                    <option value=""></option>
            ...
            <div class="field filter-field">
              ...
              <div class="field-value">
                <div class="field-control">
                  <select id="pictures-size-filter" data-filter="size" data-selectize="1">
                    <option value=""></option>
            ...
            <div class="field filter-field">
              ...
              <div class="field-value">
                <div class="field-control">
                  <select id="pictures-ratio-filter" data-filter="ratio" data-selectize="1">
                    <option value=""></option>
