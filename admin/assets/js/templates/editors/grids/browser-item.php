<?php
/**
 * Grid Editor browser item Template
 *
 * @since 3.0.0
 */
?>
		...
		<div class="post-thumbnail grid-thumbnail">
			...
			<button type="button" class="button unpublish" data-action="draft-post" title="<?php esc_html_e( 'Unpublish grid', 'wpmovielibrary' ); ?>"><span class="wpmolicon icon-unpublish"></span></button>
