...
?>
							...
							<div class="term-list">
								...
								<div class="term-item genre-item">
									...
									<# } else { #>
									<div class="term-thumbnail genre-thumbnail" style="background-image:url(<?php echo esc_url( WPMOLY_URL . 'public/assets/img/new-term-thumbnail.png' ); ?>)"></div>
									<a class="term-name genre-name" title="{{ s.sprintf( wpmolyEditorL10n.genre_does_not_exist, genre.name ) }}">{{ genre.name }}</a>
									<# } #>
								</div>
								<# } ); } else { #>
