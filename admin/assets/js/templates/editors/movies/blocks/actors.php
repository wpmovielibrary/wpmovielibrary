							...
							<div class="term-list">
								...
								<div class="term-list-inner">
									...
									<div class="term-item actor-item">
										...
										<# } else { #>
										<div class="term-thumbnail actor-thumbnail" style="background-image:url(<?php echo esc_url( WPMOLY_URL . 'public/assets/img/new-term-thumbnail.png' ); ?>)" title="{{ wpmolyEditorL10n.new_actor }}"></div>
										<a class="term-name actor-name" title="{{ s.sprintf( wpmolyEditorL10n.actor_does_not_exist, actor.name ) }}">{{ actor.name }}</a>
										<# } #>
									</div>
									<# } ); #>
								</div>
