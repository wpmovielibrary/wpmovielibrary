...
?>
				...
				<div class="editor-content active">
					<div class="panel panel-casting">
						...
						<# if ( ! _.isEmpty( data.actors ) ) { _.each( data.actors, function( actor ) { person = _.findWhere( data.persons, { name : actor.name } ); #>
					...
					<div class="panel panel-crew">
						...
						<div class="panel-section crew-section half-section">
							...
							<# if ( ! _.isEmpty( data.directors ) ) { _.each( data.directors, function( director ) { person = _.findWhere( data.persons, { name : director.name } ); #>
						...
						<div class="panel-section crew-section half-section">
							...
							<# if ( ! _.isEmpty( data.producers ) ) { _.each( data.producers, function( producer ) { person = _.findWhere( data.persons, { name : producer.name } ); #>
							<div class="person crew-member">
						...
						<div class="panel-section crew-section half-section">
							...
							<# if ( ! _.isEmpty( data.photography ) ) { _.each( data.photography, function( dop ) { person = _.findWhere( data.persons, { name : dop.name } ); #>
							<div class="person crew-member">
						...
						<div class="panel-section crew-section half-section">
							...
							<# if ( ! _.isEmpty( data.composers ) ) { _.each( data.composers, function( composer ) { person = _.findWhere( data.persons, { name : composer.name } ); #>
							<div class="person crew-member">
						...
						<div class="panel-section crew-section half-section">
							...
							<# if ( ! _.isEmpty( data.authors ) ) { _.each( data.authors, function( author ) { person = _.findWhere( data.persons, { name : author.name } ); #>
							<div class="person crew-member">
						...
						<div class="panel-section crew-section half-section">
							...
							<# if ( ! _.isEmpty( data.writers ) ) { _.each( data.writers, function( writer ) { person = _.findWhere( data.persons, { name : writer.name } ); #>
							<div class="person crew-member">
