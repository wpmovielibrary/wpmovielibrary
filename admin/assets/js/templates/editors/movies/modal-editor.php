...
?>
		...
		<div class="movie-editor-images">
			<div class="movie-editor-images-inner">
				...
				<# if ( data.posters ) { #>
					...
					<# if ( 6 <= data.posters.length ) { #><div class="movie-poster more-poster"><a href="#"><?php esc_html_e( 'More' ); ?></a></div><# } #>
				<# } else if ( data.poster ) { #>
				...
				<# if ( data.backdrops ) { #>
					...
					<# if ( 6 <= data.backdrops.length ) { #><div class="movie-backdrop more-backdrop"><a href="#"><?php esc_html_e( 'More' ); ?></a></div><# } #>
