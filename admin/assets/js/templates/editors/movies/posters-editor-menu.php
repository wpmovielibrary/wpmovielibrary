            ...
            <div class="field filter-field">
              ...
              <div class="field-value">
                <div class="field-control">
                  <select id="posters-language-filter" data-filter="language" data-selectize="1">
                    <option value=""></option>
            ...
            <div class="field filter-field">
              ...
              <div class="field-value">
                <div class="field-control">
                  <select id="posters-size-filter" data-filter="size" data-selectize="1">
                    <option value=""></option>
            ...
            <div class="field filter-field">
              ...
              <div class="field-value">
                <div class="field-control">
                  <select id="posters-ratio-filter" data-filter="ratio" data-selectize="1">
                    <option value=""></option>
