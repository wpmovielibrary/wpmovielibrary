						...
						<li id="p_<?php echo $movie['ID'] ?>">
							...
							<div class="actions column-actions">
								<div class="row-actions visible">
									<span class="dequeue"><a class="dequeue_movie" id="dequeue_<?php echo $movie['ID'] ?>" href="#" title="<?php _e( 'Dequeue', WPML_SLUG ) ?>" onclick="wpml_movies_queue.remove([<?php echo $movie['ID'] ?>]); return false;"><span class="dashicons dashicons-no"></span></a> | </span>
									<span class="delete"><a class="delete_movie" id="delete_<?php echo $movie['ID'] ?>" href="#" title="<?php _e( 'Delete', WPML_SLUG ) ?>" onclick="wpml_import_movies.delete([<?php echo $movie['ID'] ?>]); return false;"><span class="dashicons dashicons-post-trash"></span></a></span>
								</div>
							</div>
