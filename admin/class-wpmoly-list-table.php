 ...
 *
 * This is a copy of WordPress 4.1 WP_List_Table Class to prevent multiple bugs
 * with the upcoming WordPress 4.2 version. WPMOLY 2.2 will not use list tables
 * anymore so this is just temporary anyway.
 *
 * @since 3.1.0
 * @access private
 *
