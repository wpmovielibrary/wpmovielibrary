	...
	<p>
		<label><input name="<?php echo $this->get_field_name( 'media_only' ); ?>" type="radio" value="1" <?php checked( $media_only, 1 ); ?> onclick="document.getElementById('_media_only_<?php echo $this->get_field_id( 'media_only' ); ?>').style.display='block';document.getElementById('_movies_only_<?php echo $this->get_field_id( 'media_only' ); ?>').style.display='none';" /> <?php _e( 'Show Media only', WPML_SLUG ); ?></label>
		<label><input name="<?php echo $this->get_field_name( 'media_only' ); ?>" type="radio" value="0" <?php checked( $media_only, 0 ); ?> onclick="document.getElementById('_media_only_<?php echo $this->get_field_id( 'media_only' ); ?>').style.display='none';document.getElementById('_movies_only_<?php echo $this->get_field_id( 'media_only' ); ?>').style.display='block';" /> <?php _e( 'Show Movies', WPML_SLUG ); ?></label>
	</p>
	<p>
		...
		<label for="<?php echo $this->get_field_id( 'list' ); ?>"><?php _e( 'Display as dropdown', WPML_SLUG ); ?></label>
	</p>
	<p id="_list_only_<?php echo $this->get_field_id( 'css' ); ?>" class="<?php if ( 1 !== $list ) echo 'hide-if-js'; ?>">
			...
			<label for="<?php echo $this->get_field_id( 'css' ); ?>"><?php _e( 'Custom Style (only for dropdown)', WPML_SLUG ); ?></label><br />
	</p>
	<div id="_media_only_<?php echo $this->get_field_id( 'media_only' ); ?>" class="<?php if ( 1 !== $media_only ) echo 'hide-if-js'; ?>">
		<p>
	...
	<div id="_movies_only_<?php echo $this->get_field_id( 'media_only' ); ?>" class="<?php if ( 0 !== $media_only ) echo 'hide-if-js'; ?>">
		<p>
			<label for="<?php echo $this->get_field_id( 'type' ); ?>"><h4 class="wpml-widget-title"><?php _e( 'Media', WPML_SLUG ); ?></h4></label>
