	...
	<div id="_movies_only_<?php echo $this->get_field_id( 'rating_only' ); ?>" class="<?php if ( 0 !== $rating_only ) echo 'hide-if-js'; ?>">
		<p>
			<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of movies to show', WPML_SLUG ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'display_rating' ); ?>"><?php _e( 'Display movie rating', WPML_SLUG ); ?></label>
