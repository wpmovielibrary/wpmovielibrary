				...
				<div class="wpmoly-search-settings">
				...
				<div class="wpmoly-search-tools">
					<button type="button" id="wpmoly-update" data-action="update" class="icon"><span class="wpmolicon icon-update"></span></button><button type="button" id="wpmoly-empty" data-action="empty" class="icon"><span class="wpmolicon icon-no-alt"></span></button>
				</div>
