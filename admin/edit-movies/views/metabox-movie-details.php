			...
			<div id="wpml-details-minor-publishing">
				...
				<div id="wpml-details-publishing-actions">
					...
					<div class="misc-pub-section">
						...
						<a href="#movie-status" id="edit-movie-status" class="edit-movie-status hide-if-no-js" onclick="wpml_status.show(); return false;"><?php _e( 'Edit', WPML_SLUG ); ?></a>
						...
						<div id="movie-status-select" class="hide-if-js">
							...
							<select name="wpml_details[movie_status]" id="movie-status">
								<option id="movie-default-status" value="" <?php selected( '', $movie_status ); ?>><?php _e( 'None', WPML_SLUG ) ?></option>
...
<?php endforeach; ?>
							...
							<a href="#movie-status" id="save-movie-status" class="save-movie-status hide-if-no-js button" onclick="wpml_status.update(); return false;"><?php _e( 'OK', WPML_SLUG ); ?></a>
							<a href="#movie-status" id="cancel-movie-status" class="cancel-movie-status hide-if-no-js" onclick="wpml_status.revert(); return false;"><?php _e( 'Cancel', WPML_SLUG ); ?></a>
						</div>
					...
					<div class="misc-pub-section">
						...
						<a href="#movie-media" id="edit-movie-media" class="edit-movie-media hide-if-no-js" onclick="wpml_media.show(); return false;"><?php _e( 'Edit', WPML_SLUG ); ?></a>
						...
						<div id="movie-media-select" class="hide-if-js">
							...
							<select name="wpml_details[movie_media]" id="movie-media">
								<option id="movie-default-media" value="" <?php selected( '', $movie_media ); ?>><?php _e( 'None', WPML_SLUG ) ?></option>
...
<?php endforeach; ?>
							...
							<a href="#movie-media" id="save-movie-media" class="save-movie-media hide-if-no-js button" onclick="wpml_media.update(); return false;"><?php _e( 'OK', WPML_SLUG ); ?></a>
							<a href="#movie-media" id="cancel-movie-media" class="cancel-movie-media hide-if-no-js" onclick="wpml_media.revert(); return false;"><?php _e( 'Cancel', WPML_SLUG ); ?></a>
						</div>
					...
					<div class="misc-pub-section">
						...
						<a href="#movie-rating" id="edit-movie-rating" class="edit-movie-rating hide-if-no-js" onclick="wpml_rating.show(); return false;"><?php _e( 'Edit', WPML_SLUG ); ?></a>
						...
						<div id="movie-rating-select" class="hide-if-js">
							...
							<a href="#movie-media" id="save-movie-rating" class="save-movie-rating hide-if-no-js button" onclick="wpml_rating.update(); return false;"><?php _e( 'OK', WPML_SLUG ); ?></a>
							<a href="#movie-media" id="cancel-movie-rating" class="cancel-movie-rating hide-if-no-js" onclick="wpml_rating.revert(); return false;"><?php _e( 'Cancel', WPML_SLUG ); ?></a>
						</div>
