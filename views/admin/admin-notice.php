...
<?php if ( 'api-key-error' == $notice ) : ?>
	<div class="update-nag wpmoly">
		...
		<span style="float:right">
			<a class="button-secondary" href="https://api.wplibraries.com/"><?php _e( 'Learn more about the internal API key', 'wpmovielibrary' ) ?></a>
