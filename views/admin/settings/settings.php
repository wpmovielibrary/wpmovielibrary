	...
	<div id="wpml-tabs">
		...
		<form action="options.php" method="post">
			...
			<ul class="wpml-tabs-nav">
			    <li class="wpml-tabs-nav<?php if ( 'api' == $_section || '' == $_section ) echo ' active'; ?>"><a href="<?php echo admin_url( 'admin.php?page=wpml_edit_settings&amp;wpml_section=api#wpml_section_api' ) ?>" data-section="wpml_section=api"><h4><?php _e( 'API', 'wpmovielibrary' ); ?></h4></a></li>
			    ...
			    <li class="wpml-tabs-nav<?php if ( 'legacy' == $_section ) echo ' active'; ?>"><a href="<?php echo admin_url( 'admin.php?page=wpml_edit_settings&amp;wpml_section=legacy#wpml_section_legacy' ) ?>" data-section="wpml_section=legacy"><h4><?php _e( 'Legacy', 'wpmovielibrary' ); ?></h4></a></li>
