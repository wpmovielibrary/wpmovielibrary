		...
		<div id="wpmoly-details" class="wpmoly-details">
			...
			<div id="wpmoly-details-minor-publishing">

				<div id="wpmoly-details-publishing-actions">
					...
					<div class="misc-pub-section">
						...
						<div id="movie-status-select" class="hide-if-js">
							...
							<select name="wpmoly_details[movie_status]" id="movie-status">
								<option id="movie-default-status" value="" <?php selected( '', $movie_status ); ?>><?php _e( 'None', 'wpmovielibrary' ) ?></option>
<?php foreach ( WPMOLY_Settings::get_available_movie_status() as $slug => $status ) : ?>
								<option id="movie-<?php echo $slug; ?>" value="<?php echo $slug; ?>" <?php selected( $slug, $movie_status ); ?>><?php _e( $status, 'wpmovielibrary' ) ?></option>
<?php endforeach; ?>
							</select>
							<a href="#movie-status" id="save-movie-status" class="save-movie-status hide-if-no-js button" onclick="wpmoly_status.update(); return false;"><?php _e( 'OK', 'wpmovielibrary' ); ?></a>
							<a href="#movie-status" id="cancel-movie-status" class="cancel-movie-status hide-if-no-js" onclick="wpmoly_status.revert(); return false;"><?php _e( 'Cancel', 'wpmovielibrary' ); ?></a>
						</div>
					...
					<div class="misc-pub-section">
						...
						<div id="movie-media-select" class="hide-if-js">
							...
							<select name="wpmoly_details[movie_media]" id="movie-media">
								<option id="movie-default-media" value="" <?php selected( '', $movie_media ); ?>><?php _e( 'None', 'wpmovielibrary' ) ?></option>
<?php foreach ( WPMOLY_Settings::get_available_movie_media() as $slug => $media ) : ?>
								<option id="movie-<?php echo $slug; ?>" value="<?php echo $slug; ?>" <?php selected( $slug, $movie_media ); ?>><?php _e( $media, 'wpmovielibrary' ) ?></option>
<?php endforeach; ?>
							</select>
							<a href="#movie-media" id="save-movie-media" class="save-movie-media hide-if-no-js button" onclick="wpmoly_media.update(); return false;"><?php _e( 'OK', 'wpmovielibrary' ); ?></a>
							<a href="#movie-media" id="cancel-movie-media" class="cancel-movie-media hide-if-no-js" onclick="wpmoly_media.revert(); return false;"><?php _e( 'Cancel', 'wpmovielibrary' ); ?></a>
						</div>
					...
					<div class="misc-pub-section">
						...
						<div id="movie-rating-select" class="hide-if-js">
							...
							<input type="number" class="hide-if-js" id="movie-rating" name="wpmoly_details[movie_rating]" step="0.5" min="0.0" max="5.0" value="<?php echo $movie_rating; ?>"></input>
							...
							<a href="#movie-media" id="save-movie-rating" class="save-movie-rating hide-if-no-js button" onclick="wpmoly_rating.update(); return false;"><?php _e( 'OK', 'wpmovielibrary' ); ?></a>
							<a href="#movie-media" id="cancel-movie-rating" class="cancel-movie-rating hide-if-no-js" onclick="wpmoly_rating.revert(); return false;"><?php _e( 'Cancel', 'wpmovielibrary' ); ?></a>
						</div>
		...
		<div id="wpmoly-details-major-publishing-actions" class="hide-if-no-js">
			<div id="wpmoly-details-status"></div>
			<div id="wpmoly-details-major-publishing-action">
				<span class="spinner"></span>
				<?php wpmoly_nonce_field( 'save-movie-details', $referer = false ) ?>
				<input type="submit" name="wpmoly_save" id="wpmoly_save" class="button button-secondary button-large" value="<?php _e( 'Save', 'wpmovielibrary' ); ?>" accesskey="s" onclick="wpmoly_edit_details.save(); return false;" />
				<input name="wpmoly_details_save" type="hidden" id="wpmoly_details_save" value="<?php _e( 'Save', 'wpmovielibrary' ); ?>" />
			</div>
			<div class="clear"></div>
		</div>