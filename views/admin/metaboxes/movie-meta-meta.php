...
<?php endforeach; ?>
								...
								<a id="tmdb_search" name="wpmoly[tmdb_search]" title="<?php _e( 'Search', 'wpmovielibrary' ); ?>" href="<?php echo get_edit_post_link() ?>&amp;wpmoly_auto_fetch=1" class="button button-secondary button-icon"><span class="wpmolicon icon-search"></span></a>
								<a id="tmdb_update" name="wpmoly[tmdb_update]" title="<?php _e( 'Update', 'wpmovielibrary' ); ?>" href="<?php echo get_edit_post_link() ?>&amp;wpmoly_auto_fetch=1" class="button button-secondary button-icon"><span class="wpmolicon icon-update"></span></a>
								<span class="spinner"></span>
								<?php wpmoly_nonce_field( 'empty-movie-meta' ) ?>
								<a id="tmdb_empty" name="wpmoly[tmdb_empty]" title="<?php _e( 'Empty Results', 'wpmovielibrary' ); ?>" class="button button-secondary button-empty button-icon hide-if-no-js"><span class="wpmolicon icon-cancel"></span></a>
							</div>
