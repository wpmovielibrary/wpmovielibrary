		...
		<div id="wpmoly-meta" class="wpmoly-meta">
			...
			<ul id="wpmoly-meta-menu" class="hide-if-no-js">
				<li id="wpmoly-meta-preview" class="tab"><a href="#" onclick="wpmoly_meta_panel.navigate( 'preview' ) ; return false;"><span class="dashicons dashicons-editor-video"></span>&nbsp; <span class="text">Aperçu</span></a></li>
				<li id="wpmoly-meta-meta" class="tab active"><a href="#" onclick="wpmoly_meta_panel.navigate( 'meta' ) ; return false;"><span class="dashicons dashicons-clipboard"></span>&nbsp; <span class="text">Métadonnées</span></a></li>
