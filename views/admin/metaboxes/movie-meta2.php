		...
		<div id="wpmoly-meta" class="wpmoly-meta">
			...
			<ul id="wpmoly-meta-menu" class="hide-if-no-js">
				<li id="wpmoly-meta-preview" class="tab<?php if ( ! $empty ) echo ' active' ?>"><a href="#" onclick="wpmoly_meta_panel.navigate( 'preview' ) ; return false;"><span class="wpmolicon icon-video"></span>&nbsp; <span class="text">Aperçu</span></a></li>
				<li id="wpmoly-meta-meta" class="tab<?php if ( $empty ) echo ' active' ?>"><a href="#" onclick="wpmoly_meta_panel.navigate( 'meta' ) ; return false;"><span class="wpmolicon icon-meta"></span>&nbsp; <span class="text">Métadonnées</span></a></li>
