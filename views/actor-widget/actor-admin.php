...
?>
	...
	<p>
		...
		<label for="<?php echo $widget->get_field_id( 'limit' ); ?>"><h4 class="wpml-widget-title"><?php _e( 'Number of actors to show', 'wpmovielibrary' ); ?></h4></label>
		<input id="<?php echo $widget->get_field_id( 'limit' ); ?>" name="<?php echo $widget->get_field_name( 'limit' ); ?>" type="text" size="3" value="<?php echo esc_attr( $limit ); ?>" /> <em><?php _e( 'Set to 0 to disable limit. Not recommended.', 'wpmovielibrary' ); ?></em>
	</p>