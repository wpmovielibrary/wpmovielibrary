				...
				<div class="welcome-panel-content">
					...
					<div class="welcome-panel-column-container">
						...
						<div class="welcome-panel-column">
							...
							<ul>
								<li><span class="dashicons dashicons-welcome-write-blog"></span><a href="<?php echo admin_url( 'post-new.php?post_type=movie' ) ?>"><?php _e( 'Create your first movie', 'wpmovielibrary' ); ?></a></li>
								<li><span class="dashicons dashicons-list-view"></span><a href="<?php echo admin_url( 'admin.php?page=wpml_import' ) ?>"><?php _e( 'Import lists of movies', 'wpmovielibrary' ); ?></a></li>
						...
						<div class="welcome-panel-column">
							...
							<ul>
								...
								<li><a href="<?php echo admin_url( '' ) ?>"><?php _e( '', 'wpmovielibrary' ); ?></a></li>
								<li><a href=""><?php _e( '', 'wpmovielibrary' ); ?></a></li>
							</ul>
						</div>
					</div>
				</div>
