...
?>
	...
	<div id="_movies_only_<?php echo $widget->get_field_id( 'rating_only' ); ?>" class="<?php if ( 0 !== $rating_only ) echo 'hide-if-js'; ?>">
		<p>
			<label for="<?php echo $widget->get_field_id( 'number' ); ?>"><h4 class="wpml-widget-title"><?php _e( 'Number of movies to show', WPML_SLUG ); ?></h4></label> 
		...
		<p>
			<label for="<?php echo $widget->get_field_id( 'display_rating' ); ?>"><h4 class="wpml-widget-title"><?php _e( 'Display movie rating', WPML_SLUG ); ?></h4></label>
