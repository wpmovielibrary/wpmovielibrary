...
?>
	...
	<div id="_movies_only_<?php echo $widget->get_field_id( 'rating_only' ); ?>" class="<?php if ( 0 !== $rating_only ) echo 'hide-if-js'; ?>">
		<p>
			<label for="<?php echo $widget->get_field_id( 'number' ); ?>"><h4 class="wpml-widget-title"><?php _e( 'Number of movies to show', 'wpmovielibrary-admin' ); ?></h4></label> 
		...
		<p>
			<label for="<?php echo $widget->get_field_id( 'display_rating' ); ?>"><h4 class="wpml-widget-title"><?php _e( 'Display movie rating', 'wpmovielibrary-admin' ); ?></h4></label>
			<select id="<?php echo $widget->get_field_id( 'display_rating' ); ?>" name="<?php echo $widget->get_field_name( 'display_rating' ); ?>">
				<option value="no" <?php selected( $display_rating, 'no' ); ?>><?php _e( 'No', 'wpmovielibrary-admin' ); ?></option>
				<option value="below" <?php selected( $display_rating, 'below' ); ?>><?php _e( 'Below Poster', 'wpmovielibrary-admin' ); ?></option>
				<option value="above" <?php selected( $display_rating, 'above' ); ?>><?php _e( 'Above Poster', 'wpmovielibrary-admin' ); ?></option>
			</select>
		</p>
	</div>
