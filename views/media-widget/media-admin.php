...
?>
	...
	<p>
		...
		<label for="<?php echo $widget->get_field_id( 'list' ); ?>"><?php _e( 'Display as dropdown', 'wpmovielibrary' ); ?></label>
	</p>
	<p id="_list_only_<?php echo $widget->get_field_id( 'css' ); ?>" class="<?php if ( 1 !== $list ) echo 'hide-if-js'; ?>">
			...
			<label for="<?php echo $widget->get_field_id( 'css' ); ?>"><?php _e( 'Custom Style (only for dropdown)', 'wpmovielibrary' ); ?></label><br />
	</p>
	...
	<div id="_movies_only_<?php echo $widget->get_field_id( 'media_only' ); ?>" class="<?php if ( 0 !== $media_only ) echo 'hide-if-js'; ?>">
		<p>
			<label for="<?php echo $widget->get_field_id( 'type' ); ?>"><h4 class="wpml-widget-title"><?php _e( 'Media', 'wpmovielibrary' ); ?></h4></label>
		...
		<p>
			...
			<label for="<?php echo $widget->get_field_id( 'thumbnails' ); ?>"><?php _e( 'Show thumbnails', 'wpmovielibrary' ); ?></label><br />
		</p>
	</div>