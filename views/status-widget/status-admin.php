...
?>
	...
	<p>
			...
			<label for="<?php echo $widget->get_field_id( 'list' ); ?>"><?php _e( 'Display as dropdown', WPML_SLUG ); ?></label><br />
	</p>
	...
	<div id="_movies_only_<?php echo $widget->get_field_id( 'status_only' ); ?>" class="<?php if ( 0 !== $status_only ) echo 'hide-if-js'; ?>">
		<p>
			<label for="<?php echo $widget->get_field_id( 'type' ); ?>"><h4 class="wpml-widget-title"><?php _e( 'Status', WPML_SLUG ); ?></h4></label>
		...
		<p>
			...
			<label for="<?php echo $widget->get_field_id( 'thumbnails' ); ?>"><?php _e( 'Show thumbnails', WPML_SLUG ); ?></label>
		</p>
	</div>