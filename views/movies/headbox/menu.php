...
<?php foreach ( $links as $slug => $link ) : ?>
				<a href="#movie-headbox-<?php echo $slug ?>-<?php echo $id ?>" onclick="wpmoly_headbox.toggle( '<?php echo $slug ?>', <?php echo $id ?> ); return false;"><span class="wpmolicon icon-<?php echo $link['icon'] ?>" title="<?php echo $link['title'] ?>"></span></a>
