	...
	public function __construct() {
		...
		$this->taxonomies = array(
			...
			'department' => array(
				'args'  => array(
					'labels' => array(
						'name'                       => __( 'Departments', 'wpmovielibrary' ),
						'add_new_item'               => __( 'New Department', 'wpmovielibrary' ),
						'search_items'               => __( 'Search Departments', 'wpmovielibrary' ),
						'popular_items'              => __( 'Popular Departments', 'wpmovielibrary' ),
						'all_items'                  => __( 'All Departments', 'wpmovielibrary' ),
						'parent_item'                => __( 'Parent Department', 'wpmovielibrary' ),
						'parent_item_colon'          => __( 'Parent Department:', 'wpmovielibrary' ),
						'edit_item'                  => __( 'Edit Department', 'wpmovielibrary' ),
						'view_item'                  => __( 'View Department', 'wpmovielibrary' ),
						'update_item'                => __( 'Update Department', 'wpmovielibrary' ),
						'add_new_item'               => __( 'Add New Department', 'wpmovielibrary' ),
						'new_item_name'              => __( 'New Department Name', 'wpmovielibrary' ),
						'separate_items_with_commas' => __( 'Separate departments with commas', 'wpmovielibrary' ),
						'add_or_remove_items'        => __( 'Add or remove departments', 'wpmovielibrary' ),
						'choose_from_most_used'      => __( 'Choose from the most used departments', 'wpmovielibrary' ),
						'not_found'                  => __( 'No departments found.', 'wpmovielibrary' ),
						'no_terms'                   => __( 'No departments', 'wpmovielibrary' ),
						'items_list_navigation'      => __( 'Departments list navigation', 'wpmovielibrary' ),
						'items_list'                 => __( 'Departments list', 'wpmovielibrary' ),
					),
					//'rest_controller_class' => '\wpmoly\rest\endpoints\Terms_Controller',
				),
				...
				'rewrite'   => array(
					'slug' => _x( 'department', 'slug', 'wpmovielibrary' ),
				),
			),
			'genre' => array(
				'slug'  => 'genre',
