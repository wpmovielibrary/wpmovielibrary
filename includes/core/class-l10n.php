...
class L10n {
	...
	private function localize_admin_scripts() {
		...
		$localized = array(
			...
			'publish'        => esc_html__( 'Publish', 'wpmovielibrary' ),
			'set_as_draft'   => esc_html__( 'Set as draft', 'wpmovielibrary' ),
			'delete'         => esc_html__( 'Delete', 'wpmovielibrary' ),
		...
		$localized_movie = $localized + array(
			...
			'old_editor_label' => esc_html__( 'Classic Editor', 'wpmovielibrary' ),
			'view_label'       => esc_html__( 'View Movie', 'wpmovielibrary' ),
	    ...
	    'tv_release'                 => esc_html__( 'TV release', 'wpmovielibrary' ),
			...
			'no_poster_available'        => esc_html__( 'No poster available for download. Maybe upload some custom one?', 'wpmovielibrary' ),
			'no_backdrop_available'      => esc_html__( 'No backdrop available for download. Maybe upload some custom ones?', 'wpmovielibrary' ),
		...
		$localized_person = $localized + array(
			...
			'snapshot_label'   => esc_html__( 'Refresh Snapshot', 'wpmovielibrary' ),
			'old_editor_label' => esc_html__( 'Classic Editor', 'wpmovielibrary' ),
			'view_label'       => esc_html__( 'View Person', 'wpmovielibrary' ),
			'search_posts'     => esc_html__( 'Search persons', 'wpmovielibrary' ),
			'post_title'       => esc_html__( 'Title' ),
			...
			'backdrop_removed'        => esc_html__( 'Backdrop has been removed from the collection. Media remains in the library.', 'wpmovielibrary' ),
			'no_picture_available'    => esc_html__( 'No picture available for download. Maybe upload some custom one?', 'wpmovielibrary' ),
			'no_backdrop_available'   => esc_html__( 'No backdrop available for download. Maybe upload some custom ones?', 'wpmovielibrary' ),
			'view_attachment'         => esc_html__( 'View Attachment', 'wpmovielibrary' ),
			'upload_fail'             => esc_html__( 'Upload failed.', 'wpmovielibrary' ),
			'upload_success'          => __( 'Media uploaded successfully. <a href="%s" target="_blank">View Media</a>.', 'wpmovielibrary' ),
