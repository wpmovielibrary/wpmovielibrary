...
class L10n {
	...
	private function localize_admin_scripts() {
		...
		$localized_grid = $localized + array(
			...
			'old_edit_label'   => esc_html__( 'Classic grid browser', 'wpmovielibrary' ),
			'old_editor_label' => esc_html__( 'Classic grid editor', 'wpmovielibrary' ),
		...
		$localized_movie = $localized + array(
			...
			'old_edit_label'   => esc_html__( 'Classic movie browser', 'wpmovielibrary' ),
			'old_editor_label' => esc_html__( 'Classic movie editor', 'wpmovielibrary' ),
