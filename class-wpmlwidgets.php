...
class WPML_Widget_Recent_Movies_Widget extends WP_Widget {
...
add_action( 'widgets_init', create_function( '', 'register_widget("WPML_Widget_Recent_Movies_Widget");' ) );


class WPML_Widget_Most_Rated_Movies_Widget extends WP_Widget {
...
add_action( 'widgets_init', create_function( '', 'register_widget("WPML_Widget_Most_Rated_Movies_Widget");' ) );
